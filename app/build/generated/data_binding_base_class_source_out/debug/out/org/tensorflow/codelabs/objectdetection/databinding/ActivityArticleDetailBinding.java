...
public final class ActivityArticleDetailBinding implements ViewBinding {
  ...
  private ActivityArticleDetailBinding(@NonNull LinearLayout rootView, @NonNull WebView webView) {
  ...
  public static ActivityArticleDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityArticleDetailBinding((LinearLayout) rootView, webView);
    }
